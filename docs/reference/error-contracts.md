...
For pinned requests, the 16-selection-pass ceiling is authoritative when a retry setting would otherwise permit more attempts. It bounds the whole selection loop, including branches that do not increment the transient-attempt counter.
