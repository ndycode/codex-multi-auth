...
| Document | Focus |
| --- | --- |
| [releases/v1.3.2.md](releases/v1.3.2.md) | Current stable release notes |
| [releases/v1.3.1.md](releases/v1.3.1.md) | Prior stable release notes |
| [releases/v1.3.0.md](releases/v1.3.0.md) | Previous stable release notes |
| [releases/v1.2.7.md](releases/v1.2.7.md) | Earlier stable release notes |
