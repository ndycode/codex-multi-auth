export const UI_COPY = {
	...
	settings: {
		...
		experimentalSubtitle: "Preview supervisor, sync, and backup actions before they become stable",
		experimentalHelpMenu: "Enter Select | Q Back",
		experimentalHelpPreview: "A Apply | Q Back",
		experimentalHelpStatus: "Enter Select | Q Back",
		experimentalSessionSupervisor: "Enable Codex Session Supervisor",
