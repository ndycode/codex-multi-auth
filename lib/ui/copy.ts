export const UI_COPY = {
	...
	settings: {
		...
		help: "↑↓ Move | Enter Select | / Search | Q Back",
		sectionTitle: "Basic",
		...
		interfaceModeTitle: "Interface Mode",
		interfaceModeSubtitle: "Choose between the current dashboard and the OpenTUI-style preview shell",
		interfaceModeHelp: "Enter Select | 1 Classic | 2 Preview | S Save | Q Back (No Save)",
