...
/**
 * Format the "Check flagged" main menu label, appending a positive count in parentheses.
 *
 * This pure formatter has no side effects, performs no I/O, and is safe for concurrent use; it does not interact with the filesystem and does not expose or redact tokens.
 *
 * @param flaggedCount - The number of flagged items to display; values greater than zero are shown in parentheses.
 * @returns The localized "Check flagged" label, with ` (N)` appended when `flaggedCount` is greater than zero.
 */
