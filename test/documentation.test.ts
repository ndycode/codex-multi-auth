...
describe("Documentation Integrity", () => {
	...
	it("keeps opencode wording scoped to explicit interoperability docs", () => {
	...
	it("documents non-TTY auth fallback and wrapper storage compatibility", () => {
	...
	it("locks the current pre-Experimental settings menu labels and help text", () => {
